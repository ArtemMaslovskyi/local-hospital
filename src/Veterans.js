    ...
    <section className="text-content">
      ...
      <div className="flex justify-center text-wrap">
        <div className="grid grid-cols-6 grid-rows-6 *:bg-neutral-100 *:rounded-2xl gap-2 m-6 w-[1000px] h-[1000px] place-content-center">
          <div className="row-span-5">dsfsdfsdf</div>
          ...
          <div className="col-span-3">dsfsdfsdf</div>
          <div className="row-span-2">dsfsdfsdf</div>
          ...
          <div className="row-span-4">dsfsdfsdf</div>
          <div className="col-span-3">dsfsdfsdf</div>
          <div className="col-span-2">dsfsdfsdf</div>
        </div>
      </div>
    </section>
  );
